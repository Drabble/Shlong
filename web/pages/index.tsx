  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        ...
        <p className="mt-3 text-2xl">
          You currently own  <code className="p-2 font-mono text-lg bg-gray-100 rounded-md hover:text-blue-600">
          3.5 BTC
          </code> which equal <code className="p-2 font-mono text-lg bg-gray-100 rounded-md hover:text-blue-600">
          100'000 $
          </code>
        </p>
        ...
        <div className="flex flex-wrap gap-2 items-center justify-center max-w-8xl mt-6 sm:w-full">
          <div
            className="flex justify-center items-center p-6 border w-96 rounded-xl hover:text-blue-600 focus:text-blue-600 cursor-pointer"
          >
